...
This paper shows how a minimal set of structural and behavioral models can be used to automatically generate acceptance tests. We begin by choosing models intuitive and familiar to ordinary practitioners, then describe the process of transforming them
