...
This paper introduces shows how a minimal set of structural and behavioral models can be used to automatically generate acceptance tests. We begin by chosing models intuitive and familiar to ordinary practitioners, then describe the process of transforming them
to executable test cases.

A non-trivial case study demonstrates the feasibility of the proposed approach. 
We compare conventional test quality metrics (e.g.\, line coverage, mutation score) to those of manually developped tests.
