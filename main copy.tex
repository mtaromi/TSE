...
\title{A Lightweight Approach to Model-Based Acceptance Testing Using Alloy}
%
%
...
\begin{IEEEkeywords}
Model Based Testing (MBT), Model Driven Development (MDD), Software Testing, Model Inference, Minimal Modeling 
\end{IEEEkeywords}}
